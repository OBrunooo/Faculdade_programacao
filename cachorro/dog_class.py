...
Fome: {self.hungry}
Cansaço: {self.tired}
Sono: {"Sono eterno" if self.life  == False else 'Dormindo' if self.is_sleep == True else "Acordado"} 
...
Digite 1 para brincar ou 2 para não brincar: """))
                        ...
                        print("Valor digitado inválido. Digite um valor válido ex: 1")
                if (play == 1):
